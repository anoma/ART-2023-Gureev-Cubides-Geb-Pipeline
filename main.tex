...
\begin{proof}
We can instead deal with $Sk(\mathsf{FinSet}) = \mathsf{FinOrd}$, the category of finite ordinals as clearly the equivalence preserves all relevant structure. Now suppose $(C, 1_C, 0_C, +_C, \times_C)$ is a distributive category with initial/terminal object. 
